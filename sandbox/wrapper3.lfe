...
;   > (set client (: wrapper3 client-factory))
;   #Fun<wrapper3.0.66730582>
...
;   > (set client (: wrapper3 client-factory))
;   #Fun<wrapper3.0.66730582>
;   > (set function (: wrapper3 get-method client 'get))
;   #Fun<wrapper3.1.66730582>
...
; this function is used in the following manner:
;   > (set client (: wrapper3 client-factory))
;   #Fun<wrapper3.0.131664084>
;   > (: wrapper3 send client 'get '"fooz-2")
;   "barz-2"
...
; this function is used in the following manner:
;   > (set client (: wrapper3 client-factory))
;   #Fun<wrapper3.0.87519432>
;   > (: wrapper3 get client '"fooz-4")
;   "barz-4"
